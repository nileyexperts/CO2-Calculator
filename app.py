...
st.markdown("""
## 🧭 Calculateur d'empreinte carbone multimodal
""", unsafe_allow_html=True)

st.markdown("""
Ce calculateur vous permet d'estimer les émissions de CO₂e pour un trajet multimodal. Ajoutez plusieurs segments de transport avec leur origine, destination, mode et poids.
""")
...
if st.button("Calculer l'empreinte carbone totale"):
    ...
    st.markdown(f"""
#### 🌍 Émissions totales estimées : {total_emissions:.2f} kg CO₂e
""", unsafe_allow_html=True)
