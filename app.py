...
def reset_segments():
    """
    Réinitialise la saisie des segments, les champs transitoires associés
    et le N° de dossier, puis relance l'application.
    """
    try:
        ...
        # 4) Vider aussi le N° dossier (⚠️ demandé)
